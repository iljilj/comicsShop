...
import ru.sfedu.comicsShop.model.Cart;
import ru.sfedu.comicsShop.model.Item;
import ru.sfedu.comicsShop.model.User;
...
public class DataProviderSqlTest extends TestBase {
    DataProviderSql provider = new DataProviderSql();


    @After
    public void cleanUpFiles() throws IOException, SQLException {

        Connection connection = SqlUtil.connectToMySql();
        Statement statement = connection.createStatement();
        statement.executeUpdate("TRUNCATE TABLE Item");
        statement.executeUpdate("TRUNCATE TABLE User");
        statement.executeUpdate("TRUNCATE TABLE Cart");
        statement.executeUpdate("TRUNCATE TABLE Order_");
        statement.executeUpdate("TRUNCATE TABLE PromoCode");
        statement.executeUpdate("TRUNCATE TABLE GiftCertificate");
    ...
    public void testCart(){
        ...
        assertEquals(provider.saveCart(cart1()), Status.FAULT);
